...
public class ArraySortServiceTest {
    ...
    public void testStreamSortException() {
        try {
            ...
            fail("Test streamSort for null should have thrown ArrayException");
    ...
    public void testSelectionSortException() {
        try {
            ...
            fail("Test selectionSort for null should have thrown ArrayException");
        } catch (ArrayException e) {
            assertEquals("Argument contains null", e.getMessage());
        }
    }
    ...
    public void testInsertionSortException() {
        try {
            ...
            fail("Test insertionSort for null should have thrown ArrayException");
        } catch (ArrayException e) {
            assertEquals("Argument contains null", e.getMessage());
        }
    }
    ...
    public void testQuickSortException() {
        try {
            ...
            fail("Test quickSort for null should have thrown ArrayException");
        } catch (ArrayException e) {
            assertEquals("Argument contains null", e.getMessage());
        }
    }
