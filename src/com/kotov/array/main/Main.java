...
public class Main {
    public static void main(String[] args) throws ArrayException {
        ...
        String data = reader.readDataFromFile(String.join(File.separator, "resources", "array.txt"));
        String[] numericStrings = parser.parseDataIntoNumericStrings(data);
        int[] numbers = parser.transformNumericStringArrayIntoIntArray(numericStrings);
